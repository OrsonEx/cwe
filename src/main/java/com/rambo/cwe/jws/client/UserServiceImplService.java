 ...
 */
@WebServiceClient(name = "UserServiceImplService", targetNamespace = "http://impl.jws.cwe.rambo.com/", wsdlLocation = "http://localhost:7005/cwe/ws/UserService?wsdl")
public class UserServiceImplService extends Service {
    ...
    private final static QName USERSERVICEIMPLSERVICE_QNAME = new QName("http://impl.jws.cwe.rambo.com/", "UserServiceImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:7005/cwe/ws/UserService?wsdl");
